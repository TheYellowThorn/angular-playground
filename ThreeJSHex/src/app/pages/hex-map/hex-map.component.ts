...
import { 
  ...
  Vector2, TextureLoader, SphereGeometry, MeshStandardMaterial, WebGLRenderTarget, Texture
} from 'three';
...
export class HexMapComponent implements AfterViewInit, OnInit {
  ...
  async addObjects(): Promise<void> {
    ...
    for(let i = -20; i <= 20; i++) {
      for(let j = -20; j <= 20; j++) {
        ...
        // let noise: number = (noise2D(i * 0.1, j * 0.1) + 1) * 0.5;
